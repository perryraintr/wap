;(function($, window, undefined) {
    ...
    Dialog.prototype = {
        ...
        create : function() {
            ...
            var divBackground = (this.settings.background == null)?'':'-white';
            // HTML模板
            var templates = '<div class="rDialog-wrap' + divBackground + '">' +
                                '<div class="rDialog-content' + divBackground + '">'+ this.settings.content +'</div>' +
