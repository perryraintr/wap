...
function pinSheMember() {
	var sd = localStorage.getItem("wid");
	if (sd != undefined && sd.length != 0) {
		if(sd == "o1D_JwHikK5LBt_Y__Ukr9p4tKsY" || sd == "o1D_JwGKMNWZmBYLxghYYw0GIlUg" || sd == "o1D_JwGTL0ZN81hpxJSxflvtXQj8" || sd == "o1D_JwNKxR8PqF7KX_15-aOEk2HU") {
			return true;
		} else {
			return false;
		}
